...
class CreateCategoriasProfesionalesTable extends Migration {
    ...
    public function up()
    {
        Schema::create("categorias_profesionales",function(Blueprint $table){
    ...
    {
        Schema::drop("categorias_profesionales");
    }
}
